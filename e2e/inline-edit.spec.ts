...
test.describe('Inline edit', () => {
  test('E2E-IE-01 - Double-click node header → edit → commit', async ({
    freshPage: page,
  }) => {
  ...
  test('E2E-IE-02 - ESC cancels edit and restores original label', async ({
    freshPage: page,
  }) => {
    await loadExampleProject(page);
  ...
  test('E2E-IE-03 - Empty label blocks commit (edit mode persists)', async ({
    freshPage: page,
  }) => {
    await loadExampleProject(page);
  ...
  test('E2E-IE-04 - Panel button creates a new node', async ({
    freshPage: page,
  }) => {
    await loadExampleProject(page);
  ...
  test('E2E-IE-05 - Rename via context menu opens inline edit (no browser prompt)', async ({
    freshPage: page,
  }) => {
    await loadExampleProject(page);
