...
function makeMapping(overrides: Partial<Mapping> & { kind: Mapping['kind'] }): Mapping {
  return {
    id: 'map1',
    sourceId: 'src1',
      ...
      schemaNodes: [
        {
          ...
          data: {
            ...
            properties: [{ uri: 'http://example.org/trackId', label: 'trackId', range: 'xsd:string', kind: 'datatype' }],
          },
        },
      ],
    })
