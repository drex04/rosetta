...
export function MappingEdge({ sourceX, sourceY, targetX, targetY, selected, data }: EdgeProps) {
  const groupId = (data as { groupId?: string; groupOrder?: number } | undefined)?.groupId
  const groupOrder = (data as { groupId?: string; groupOrder?: number } | undefined)?.groupOrder ?? 0
